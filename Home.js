...
const Home = () => {
  return (
    <div>
      <Header />
      <img src="https://raw.githubusercontent.com/ElzeroWebSchool/HTML_And_CSS_Template_One/main/images/logo.png" />
      ...
      <article>
        <section className={styles.idea}>
          <div>
            ...
            <p>
              ...
              consequatur. Ab ipsum, hic architecto
            </p>
          </div>
        ...
        <section className={styles.container}>
            ...
            <div className={styles.service}>
              ...
              <div className={styles.content}>
                ...
                <p>
                  ...
                  problem-solving using one or more of thypography, photography
                  and illustrarion.
                </p>
              </div>
            </div>
          ...
          <section className={styles.image}>
            <img src="https://github.com/ElzeroWebSchool/HTML_And_CSS_Template_One/blob/main/images/services.jpg?raw=true" />
          </section>
        </section>

        <section className={styles.title}>
          <h1 id="prt">Portfolio</h1>
          <p>If you do it right, it will last forever.</p>
        </section>

        <section className={styles.portfolio}>
          <div className={styles.project}>
            <img src="https://github.com/ElzeroWebSchool/HTML_And_CSS_Template_One/blob/main/images/portfolio-1.jpg?raw=true" />
            <h2>Project Here</h2>
            <p>
          ...
          {/* <!-- 2nd project --> */}
          <div className={styles.project}>
            <img src="https://github.com/ElzeroWebSchool/HTML_And_CSS_Template_One/blob/main/images/portfolio-2.jpg?raw=true" />
            <h2>Project Here</h2>
            <p>
              My creative ability is very difficult to measure because it can
              manifest in so many surprising and.
          ...
          {/* <!-- 3rd project --> */}
          <div className={styles.project}>
            <img src="https://github.com/ElzeroWebSchool/HTML_And_CSS_Template_One/blob/main/images/portfolio-3.jpg?raw=true" />
            <h2>Project Here</h2>
            <p>
              My creative ability is very difficult to measure because it can
              manifest in so many surprising and.
        ...
        <section className={styles.about}>
          <img src="https://github.com/ElzeroWebSchool/HTML_And_CSS_Template_One/blob/main/images/about.jpg?raw=true" />
          <div className={styles.paragraphs}>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde
              officiis nesciunt laudantium hic, labore dolorum molestiae
              adipisci tempore reiciendis fuga non sequi voluptate quae quidem,
              numquam assumenda incidunt, earum voluptatum!
            </p>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde
              officiis nesciunt laudantium hic, labore dolorum molestiae
      ...
      <p>
        &copy; 2022 <span>Lean</span> All Right Reserved
      </p>
    </div>
  );
};
